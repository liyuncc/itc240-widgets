...
function get_header($file=''){
    global $config;
    //global is a keyword that makes $config available in this function
    static $header_loaded = false;
    //開始 static is a keyword that makes variable $h_l not to be deleted. we need for a further task. To do this, use the static keyword when you first declare the variable.
    ...
    //this is the path to get the file
